    ...
    C: Has<XSpanIdString> + Has<Option<AuthData>> + Clone + Send + Sync + 'static,
{
        ...
        context: &C) -> Result<GetMyselfResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetMyselfResponse::HereIsYourStatus
                    (body)
                )
            }
            400 => {
                let body = response.into_body();
                Ok(
                    GetMyselfResponse::YourRequestIsJunk
                )
            }
            code => {
        ...
        context: &C) -> Result<GetNewUserResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetNewUserResponse::HereIsTheDefaultIdentity
                    (body)
                )
            }
            400 => {
                let body = response.into_body();
                Ok(
                    GetNewUserResponse::YourRequestIsJunk
                )
            }
            code => {
                let headers = response.headers().clone();
    ...
    async fn post_query(
        &self,
        param_request_body: models::Query,
        context: &C) -> Result<PostQueryResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::KillResult>(body)?;
                Ok(PostQueryResponse::HereIsTheKillResult
                    (body)
                )
            }
            201 => {
                ...
                Ok(PostQueryResponse::HereIsANewRoleForYou
                    (body)
                )
            }
            202 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::FilesList>(body)?;
                Ok(PostQueryResponse::HereAreTheFiles
                    (body)
                )
            }
            203 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::UsersList>(body)?;
                Ok(PostQueryResponse::HereAreYourCrewmates
                    (body)
                )
            }
            206 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::Notification>(body)?;
                Ok(PostQueryResponse::SomeRandomInformation
                    (body)
                )
            }
            207 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::MoveTo>(body)?;
                Ok(PostQueryResponse::HereIsTheNewLocation
                    (body)
                )
            }
            400 => {
                let body = response.into_body();
                Ok(
                    PostQueryResponse::YourRequestIsJunk
                )
            }
            500 => {
                let body = response.into_body();
                Ok(
                    PostQueryResponse::YouAreDead
                )
            }
            code => {
                let headers = response.headers().clone();
